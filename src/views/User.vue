  ...
  <main role="main">
    <div class="album py-5 bg-light">
      <div class="container">
        <div class="card mb-3">
          <!-- 使用者資料 -->
          <UserProfileCard :profile="profile" :currentUser="currentUser" :initialIsFollowed="isFollowed"/>
          <!-- 以上 -->
        </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <!-- 追蹤者 -->
            <UserFollowing :followings="profile.Followings"/>
            <!-- 以上 -->
          ...
          <div class="col-md-8">
            ...
            <br />
            <!-- 收藏餐廳 -->
            <UserFavorutedRestaurantsCard :favoritedRestaurants="profile.FavoritedRestaurants"/>
            <!-- 收藏餐廳 以上 -->
          </div>
        </div>
      </div>
...
import UserFollowing from "./../components/UserFollowingsCard";
import UserFavorutedRestaurantsCard from "./../components/UserFavoritedRestaurantsCard";
